...
export const listItemClass =
  "cursor-pointer bg-section border-section-border shadow-sm hover:border-primary/40 hover:bg-accent";
...
export const detailSectionClass =
  "rounded-lg border border-section-border bg-section p-4 shadow-sm";
export const detailSectionBodyClass =
  "mt-3 grid gap-3 rounded-md border border-section-border bg-section-muted p-3";

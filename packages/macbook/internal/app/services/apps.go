...
func (s Service) UpdateInstalledAppList(opts Options) error {
	return s.currentApps().GenerateInstalledList(currentapps.Options{DryRun: opts.DryRun, ConfigPath: opts.ConfigPath, GeneratedPath: opts.GeneratedPath})
}
...
func (s Service) currentApps() currentapps.Service {
	return currentapps.Service{Home: s.Home, Repo: s.Repo, Stdout: s.Stdout, Runner: s.Runner}
}
